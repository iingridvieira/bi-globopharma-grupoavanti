...
const MENU_ITEMS = [
  ...
  { to: "/sell-out", label: "Sell Out", desc: "Detalhamento por cliente e mapa de vendas Sell Out", icon: ShoppingCart, color: "from-violet-500/20 to-violet-500/5" },
  { to: "/por-clientes", label: "Por Clientes", desc: "Análise consolidada e individual de cada cliente", icon: Users, color: "from-rose-500/20 to-rose-500/5" },
];
