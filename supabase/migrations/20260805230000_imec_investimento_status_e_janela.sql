-- 1) Status: "cobrado" vira "programado" (a data correspondente também deixa
-- de ser "Cobrado em" e passa a ser "Programado para" na tela), e ganha um
-- novo status "nao_aplicado" (investimento que não vai ser aplicado).
...
-- 2) Amplia a janela de acompanhamento automático de 2 para 5 meses.
...
-- Traz agora, de uma vez, os 3 meses adicionais de histórico (de 2 para 5
-- meses) que ainda não estavam acompanhados.
